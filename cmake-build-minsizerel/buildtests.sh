...
then
  C:/Users/penci/AppData/Local/JetBrains/Toolbox/apps/CLion/ch-0/222.4345.21/bin/ninja/win/ninja.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/Users/penci/AppData/Local/JetBrains/Toolbox/apps/CLion/ch-0/222.4345.21/bin/ninja/win/ninja.exe $targets_to_make 
fi
exit $?
